    ...
    mySprite.update = function(d) {
        ...
        for(i = 0; i < parts.length; i++){
            ...
            if(cirOnCir(mySprite.x, mySprite.y,parts[i].x, parts[i].y, 15, parts[i].radius) ||
               cirOnCir(L1x, L1y,parts[i].x, parts[i].y, 15, parts[i].radius) ||
               cirOnCir(L2x, L2y,parts[i].x, parts[i].y, 15, parts[i].radius) ||
               cirOnCir(R1x, R1y, parts[i].x, parts[i].y, 15, parts[i].radius) ||
               cirOnCir(R2x, R2y, parts[i], parts[i].y, 15, parts[i].radius)){
            //if(cirOnCir(mySprite.x, mySprite.y,parts[i].x, parts[i].y, 15, parts[i].radius)){
                mySprite.x = canvas.width/2;
...
/************************************ ECH *****************************************/
function rotCirc(x, y, cx, cy, theta){
    var dx = x - cx;
    var dy = y - cy;
